...
import icon from '../../../../../apple-responsive-replica-html-css-mar-2020/images/icons/logo-sm.png'
			...
			<nav className="navbar navbar-toggleable-sm navbar-expand-md">
			    ...
			    <div className="navbar-collapse collapse">
			        <ul className="navbar-nav nav-justified w-100 nav-fill">
						...
						<li className="nav-item"><Link className="nav-link js-scroll-trigger" to="/iphones">iphone</Link></li>
